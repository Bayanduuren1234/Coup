    ...
    (function (factory) {
      ...
      ko.computed = ko.dependentObservable = function (
          ...
          try {
            ...
            try {
              ...
              if (disposalCount && !isSleeping) {
                ko.utils.objectForEach(
                  disposalCandidates,
                  function (id, toDispose) {
                    if (toDispose.dispose) toDispose.dispose();
                  }
                );
              }
        ...
        function peek() {
          ...
          if (
            (_needsEvaluation && !_dependenciesCount) ||
            (isSleeping && haveDependenciesChanged())
          ) {
            evaluateImmediate();
          }
          return _latestValue;
        ...
        if (options["pure"]) {
              ...
              if (_needsEvaluation || haveDependenciesChanged()) {
                ...
                ko.utils.arrayForEach(dependeciesOrder, function (id, order) {
                  var dependency = dependencyTracking[id],
                    subscription = dependency._target.subscribe(
          ...
          dependentObservable.afterSubscriptionRemove = function (event) {
            if (
              !_isDisposed &&
              event == "change" &&
              !dependentObservable.hasSubscriptionsForEvent("change")
            ) {
              ko.utils.objectForEach(
                dependencyTracking,
                function (id, dependency) {
          ...
          dependentObservable._originalGetVersion =
            dependentObservable.getVersion;
