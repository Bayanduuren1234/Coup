(function (factory) {
    ...
    for (var key in source) {
      if (source.hasOwnProperty(key) && source[key]) {
        ...
        if (
          ...
          var bothArrays =
            exports.getType(destination[key]) === "array" &&
            exports.getType(source[key]) === "array";
          if (bothArrays) {
  ...
  function withProxyDependentObservable(dependentObservables, callback) {
    ...
    ko.dependentObservable = function (read, owner, options) {
      ...
      var realDependentObservable = new realKoDependentObservable(
        read,
        owner,
        options
      );
  ...
  function updateViewModel(
    ...
    var isArray =
      exports.getType(ko.utils.unwrapObservable(rootObject)) === "array";
    ...
    if (exports.isMapped(mappedRootObject)) {
      var previousMapping =
        ko.utils.unwrapObservable(mappedRootObject)[mappingProperty];
    ...
    var hasCreateCallback = function () {
      return (
        options[parentName] && options[parentName].create instanceof Function
      );
    };
    ...
    var hasUpdateCallback = function () {
      return (
        options[parentName] && options[parentName].update instanceof Function
      );
    };
    ...
    if (!isArray) {
      ...
      if (!canHaveProperties(rootObject)) {
        switch (exports.getType(rootObject)) {
          ...
          default:
            if (ko.isWriteableObservable(mappedRootObject)) {
              ...
              var hasCreateOrUpdateCallback =
                hasCreateCallback() || hasUpdateCallback();

              if (hasCreateCallback()) {
                mappedRootObject = createCallback();
              } else {
                mappedRootObject = ko.observable(
                  ko.utils.unwrapObservable(rootObject)
                );
              }
        ...
        visitPropertiesOrArrayEntries(rootObject, function (indexer) {
          var fullPropertyName = parentPropertyName.length
            ? parentPropertyName + "." + indexer
            : indexer;
          ...
          if (
            typeof rootObject[indexer] != "object" &&
            typeof rootObject[indexer] != "array" &&
            options.observe.length > 0 &&
            ko.utils.arrayIndexOf(options.observe, fullPropertyName) == -1
          ) {
            mappedRootObject[indexer] = rootObject[indexer];
          ...
          var retval = updateViewModel(
            mappedRootObject[indexer],
            rootObject[indexer],
            options,
            indexer,
            mappedRootObject,
      ...
      var currentArrayKeys = filterArrayByKey(
        ko.utils.unwrapObservable(mappedRootObject),
        keyCallback
      ).sort();
  ...
  exports.visitModel = function (rootObject, callback, options) {
    ...
    visitPropertiesOrArrayEntries(unwrappedRootObject, function (indexer) {
      if (
        options.ignore &&
        ko.utils.arrayIndexOf(options.ignore, indexer) != -1
      )
        return;

      var propertyValue = unwrappedRootObject[indexer];
      options.parentName = getPropertyName(
        parentName,
        unwrappedRootObject,
        indexer
      );
      ...
      if (ko.utils.arrayIndexOf(options.copy, indexer) === -1) {
        ...
        if (ko.utils.arrayIndexOf(options.include, indexer) === -1) {
          ...
          if (
            unwrappedRootObject[mappingProperty] &&
      ...
      switch (exports.getType(ko.utils.unwrapObservable(propertyValue))) {
        ...
        case "undefined":
          ...
          mappedRootObject[indexer] =
            exports.getType(previouslyMappedValue) !== "undefined"
              ? previouslyMappedValue
              : exports.visitModel(propertyValue, callback, options);
          break;
        default:
          mappedRootObject[indexer] = callback(
            propertyValue,
            options.parentName
          );
      }
