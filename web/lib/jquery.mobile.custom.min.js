      ...
      (o = (function () {
        function p() {
          var n = l(),
            r = h(u);
          n !== u
            ? (c((u = n), r), e(t).trigger(i))
            : r !== u && (location.href = location.href.replace(/#.*/, "") + r),
              ...
              (n.start = function () {
                ...
                (c = function (n, r) {
                  ...
                  n !== r &&
                    ...
                    o.open(),
                    u &&
                      o.write('<script>document.domain="' + u + '"</script>'),
                    o.close(),
                    (t.location.hash = n));
                });
            })(),
      ...
      var i = function (t, n) {
        var r = t.parent(),
          ...
          s = function () {
            var t = e(this),
              n =
                e.mobile.toolbar && t.data("mobile-toolbar")
                  ? t.toolbar("option")
                  : {
                      position: t.attr("data-" + e.mobile.ns + "position"),
                      updatePagePadding:
                        t.attr(
                          "data-" + e.mobile.ns + "update-page-padding"
                        ) !== !1,
                    };
        ...
        return (
          u.length === 0 && o.length > 0 && (i = i.concat(o.toArray())),
        ...
        (e.event.special.navigate = r =
          {
            ...
            hashchange: function (t) {
              ...
              if (i.isDefaultPrevented()) return;
              (r.originalEvent = t),
                n.trigger(r, { state: t.hashchangeState || {} });
            },
            setup: function () {
              if (r.bound) return;
              (r.bound = !0),
                r.isPushStateEnabled()
                  ? ((r.originalEventName = "popstate"),
                    n.bind("popstate.navigate", r.popstate))
                  : r.isHashChangeEnabled() &&
                    ((r.originalEventName = "hashchange"),
        ...
        e.event.special.orientationchange,
        {
          setup: function () {
            if (
              ...
              !e.event.special.orientationchange.disabled
            )
              return !1;
