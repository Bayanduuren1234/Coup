  ...
  function y(b, c) {
    ...
    for (d in c)
      if (c.hasOwnProperty(d) && c[d])
        if (
          ((a = f.getType(b[d])), d && b[d] && "array" !== a && "string" !== a)
        )
          y(b[d], c[d]);
        else if ("array" === f.getType(b[d]) && "array" === f.getType(c[d])) {
          a = b;
          for (
            var e = d, l = b[d], n = c[d], t = {}, g = l.length - 1;
            0 <= g;
            --g
          )
            t[l[g]] = l[g];
  ...
  function F(b, c, a, d, k, l, n) {
    ...
    var j = n || k,
      ...
      x = function (b) {
        ...
        b =
          e.utils.unwrapObservable(k) instanceof Array
            ? a[d].create({ data: b || c, parent: j, skip: N })
    ...
    if (t) {
      ...
      a[d] &&
        a[d].arrayChanged &&
        e.utils.arrayForEach(t, function (b) {
      ...
      Q(c, function (d) {
        ...
        if (-1 == e.utils.arrayIndexOf(a.ignore, f))
          if (-1 != e.utils.arrayIndexOf(a.copy, f)) b[d] = c[d];
            ...
            "array" != typeof c[d] &&
            0 < a.observe.length &&
            -1 == e.utils.arrayIndexOf(a.observe, f)
          )
  ...
  f.visitModel = function (b, c, a) {
    ...
    Q(k, function (b) {
      if (!(a.ignore && -1 != e.utils.arrayIndexOf(a.ignore, b))) {
        ...
        if (
          !(
            -1 === e.utils.arrayIndexOf(a.copy, b) &&
            -1 === e.utils.arrayIndexOf(a.include, b) &&
            k[p] &&
